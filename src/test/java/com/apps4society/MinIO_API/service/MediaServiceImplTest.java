...
class MediaServiceImplTest {
    ...
    void testSaveMedia_duplicateFile_throwsDuplicateFileException() {
        MockMultipartFile file = new MockMultipartFile("file", "test-image.png", "image/png", "dummy".getBytes());
        when(mediaRepository.existsByFileNameAndActive("test-image.png", true)).thenReturn(true);
    ...
    void testGetMediaUrl_mediaNotFound_throwsMediaNotFoundException() {
        when(mediaRepository.findByIdAndServiceName(1L, "educAPI")).thenReturn(Optional.empty());
    ...
    void testGetMediaUrl_successful() throws Exception {
        Media media = Media.builder()
                ...
                .fileName("test-image.png")
                .build();
        when(mediaRepository.findByIdAndServiceName(1L, "educAPI")).thenReturn(Optional.of(media));
    ...
    void testUpdateMedia_successful() throws Exception {
        ...
        Media existingMedia = Media.builder()
                ...
                .active(true)
                .build();
        when(mediaRepository.findByIdAndServiceName(1L, "educAPI")).thenReturn(Optional.of(existingMedia));
